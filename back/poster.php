<form action="./api/edit_poster.php" method="post">
    ...
    <div style="height:250px;overflow:scroll;">
        <table style="width:100%;margin:auto;">
            ...
            ?>
            <tr>
                <td style="text-align:center;width:24.5%;"><img src="./img/<?= $row['img'] ?>"
                ...
                <td style="text-align:center;width:24.5%;">
                    <input type="button" value="往上" data-id="<?= $row['id'] ?>"
                        data-sw="<?= ($idx != 0) ? $rows[$idx - 1]['id'] : $row['id'] ?>"> <input type="button"
                        value="往下" data-id="<?= $row['id'] ?>"
